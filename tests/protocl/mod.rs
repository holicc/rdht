...
fn test_ping_decode() {
    ...
    assert_eq!(
        ping,
        Ok(KRPC::Response(DHTResponse::ID {
...
fn test_find_node_decode() {
    ...
    assert_eq!(
        find_node,
        Ok(KRPC::Query(DHTQuery::FindNode {
            id: "abcdefghij0123456789".to_string(),
    ...
    assert_eq!(
        find_node,
        Ok(KRPC::Response(DHTResponse::FindNode {
...
fn test_announce_peer_decode() {
    ...
    assert_eq!(
        announce_peer,
        Ok(KRPC::Query(DHTQuery::AnnouncePeer {
            id: "abcdefghij0123456789".to_string(),
            impiled_port: 1,
            port: 6881,
